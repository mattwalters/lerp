...
verdict on the ticket or in Needs Attention saying what stopped it. Nothing
enforces that mechanically, but the verdict comment is the artifact that
proves the review ran, and the board reads it into the main pane — so a
ticket resting in In Review with no verdict on it reads as unfinished at a
glance, without opening GitHub to find out.
