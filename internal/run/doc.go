...
//
// macOS and Linux only: a run is its own process group, killed by
// process-group id. Every file here carries a //go:build unix constraint,
// so a new one needs it too.
package run
